...
                          {<img src={`/lovable-uploads/09c9c3e9-bf1b-4a8c-bc82-9ddca3584d4b.png`} alt={type} className="w-5 h-5 mr-2" />}
                          <div className="w-5 h-5 bg-gray-300 dark:bg-gray-600 mr-2 rounded-full flex items-center justify-center text-xs">IMG</div> {/* Placeholder image representation */}
                          {type}
                        </div>
                      </SelectItem>
                    ))}
