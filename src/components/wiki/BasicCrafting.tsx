    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <div className="flex justify-center mb-6">
            <img src="/placeholder.svg" alt="Nung nóng thỏi sắt hoặc vàng" className="rounded-lg shadow-md max-w-full h-auto" />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <div className="flex justify-center mb-6">
            <img src="/placeholder.svg" alt="Kim cương không ổn định" className="rounded-lg shadow-md max-w-full h-auto" />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <div className="flex justify-center mb-4">
            <img src="/placeholder.svg" alt="Thông báo cần đe" className="rounded-lg shadow-md max-w-full h-auto" />
          </div>
          <p className="mb-4">
            Đặt một cái đe (công thức chế tạo không thay đổi) trong vòng 5 khối xung quanh bàn chế tạo để tiếp tục.
          </p>
          <div className="flex justify-center mb-6">
            <img src="/placeholder.svg" alt="Đặt đe gần bàn chế tạo" className="rounded-lg shadow-md max-w-full h-auto" />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <div className="flex justify-center mb-6">
            <img src="/placeholder.svg" alt="Trang bị đồng" className="rounded-lg shadow-md max-w-full h-auto" />
          </div>
        </CardContent>
      </Card>
    </div>
