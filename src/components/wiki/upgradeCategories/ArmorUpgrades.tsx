...
const ArmorUpgrades = () => {
  const upgrades = [
    ...
    { title: "Ổn định", description: "Tăng +10% kháng đẩy lùi.", imagePath: "/lovable-uploads/57_1_1_352758925-dac9e67c-5715-42ca-b4b0-a31a91b6c096.png.25df49d2-eee8-4747-aaf6-7110b15e1d2f.png" },
    { title: "Cứu rỗi", description: "Tăng +10% kháng chảy máu.", imagePath: "/lovable-uploads/58_1_1_352758973-6922fb8a-a3fb-49a2-83c2-84e70db4eefe.png.44c70d77-fc43-4998-87ff-1443c60b578f.png" },
    { title: "Nhận thức", description: "Tăng +10% kháng sát thương chí mạng.", imagePath: "/lovable-uploads/59_1_1_352759440-1b716ada-27e9-42c0-bdfe-963bdd466a03.png.e9f12e5d-6adc-45fe-a76c-961a3e0db137.png" },
    { title: "Tiết độ", description: "Tăng +10% kháng choáng, giảm thời gian choáng.", imagePath: "/lovable-uploads/60_1_1_352759514-6ce962db-6c7b-4afd-a8f0-803878361f25.png.f52bb364-9b17-496a-b589-7a574d2e39bb.png" },
