...
import { 
  Shield, ShieldOff, Droplets, ChevronRight, ShoppingBag, Zap, 
  Star, Heart, ArrowRightLeft, Percent 
} from "lucide-react";
...
const WeaponUpgrades = () => {
  const upgrades = [
    ...
    { title: "Đẩy ra", description: "Tăng +100% cơ hội hất ngã kẻ địch đang cưỡi (như ngựa hoặc nhện).", icon: ChevronRight },
    ...
    { title: "Chấn động", description: "Tăng +5% cơ hội choáng. Lưu ý rằng kẻ địch bị choáng sẽ miễn nhiễm với choáng trong vài giây.", icon: Zap },
    { title: "Kéo dài", description: "Tăng +0.25 khối tầm đánh (chỉ vũ khí cận chiến).", icon: ArrowRightLeft },
